    ...
    <div className="space-y-6">
        ...
        <div className="lg:col-span-8 athena-card p-6 flex flex-col justify-between border-slate-700 bg-slate-900/60">
          ...
          <div className="pt-5 flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-lg bg-slate-900 border border-slate-700 hover:bg-slate-800 text-slate-300 font-medium text-xs transition-colors"
            >
            ...
            >
              ...
              Check Form with CV Coach
            </button>
          </div>
        </div>
      </div>

      {/* Answers to Core Questions: "What changed?" & "What can I improve?" */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="athena-card p-4 space-y-2">
          ...
          <div className="text-xs text-slate-300 leading-relaxed">
            Nutritional protein distribution is concentrated in dinner. Adding 15g protein at breakfast stabilizes daytime glucose and muscle synthesis.
          </div>
        </div>
